...
(function() {
    ...
    var basecamp_tt = {
        ...
        loadMarketingInfo: function() {
            var maxHours, overviewName, showInOverview, includedProjectsArray, includedProjects, dangerValue, i, progressBar, minutesToTwoDecimal, str, headers, progressValuesText, optionStorage, url, username, password, companyName, itemsJson, marketingProgressValue, marketingProgressMax;
            str = window.location.href;
            if(basecamp_tt.getNumberFromItemId(str)) {
        ...
        addTaskToTimeTracker: function() {
            var addButtons, taskId, taskExtractedNum, taskName, tasks, taskStoragePromise, i, taskUrl, taskItem, taskCompany, taskProject;
